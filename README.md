...
- **Polished PS 2**: [CSEcon206-Haowen-PS2](https://github.com/Rising-Stars-by-Sunshine/CSEcon206-Haowen-PS2), the following modifications have been made:
  ...
  - The PDF has been uploaded to the repo and attached in the spotlight
  - The text in the readme was polished by Grammarly
...
- Figures
  ...
  - The detailed information about the game can be found at this [PDF](https://github.com/Rising-Stars-by-Sunshine/csecon206-haowen-finalproject/blob/main/spotlight/CSECON206_Final_Spring2023_Haowen.pdf)
...
- **Self Introduction**: 
Haowen Ji is a senior student in Data Science major at DKU, who is interested in the data science’s application in the real world, such as price evaluation and automatic driving and still seeking more implementation opportunities to leverage data science.

- Final reflections 
  - Intellectual growth: Researching and applying machine learning techniques to solve social and economic issues, specifically in the context of the penalty kick game, can lead to significant intellectual growth. By delving into interdisciplinary research on this topic, I gained insights from various fields such as game theory, statistics, sports analytics, and machine learning. This interdisciplinary approach enables me to develop a comprehensive understanding of the game dynamics, strategic decision-making, and the impact of shooting probabilities and player skills on game outcomes. Additionally, exploring the application of machine learning algorithms to optimize strategies enhanced my analytical and problem-solving skills, as well as deepen my understanding of how technology can be leveraged to address real-world challenges.
  - Professional growth: researching the penalty kick game equips me with a unique combination of skills. I develop expertise in game theory, data analysis, and machine learning, which are highly valuable in the fields of sports analytics, decision-making, and optimization. These skills can open up opportunities for me to work in sports organizations, consulting firms, or academic institutions where I can contribute to the development of advanced analytics models and strategies. Furthermore, the practical application of machine learning in the penalty kick game allows me to build a strong professional profile as someone who can bridge the gap between theoretical concepts and practical solutions.
  - Living a purposeful life: As I envision my future accomplishments, winning a Nobel Prize or Turing Award in the field of machine learning and sports analytics could be a testament to my contributions to advancing human civilization. My feature sentence could highlight my pioneering work in developing innovative machine learning algorithms and strategies for optimizing penalty kick performance. By leveraging the power of data and technology, I have revolutionized the understanding of optimal strategies in sports and have made significant contributions to the improvement of decision-making processes in high-stakes scenarios. This recognition not only brings personal fulfillment but also establishes me as a trailblazer in the field, inspiring future researchers to explore the intersection of machine learning and sports.
